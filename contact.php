  ...
  <main id="main" class="main">
    ...
    <section class="section profile">
      <div class="row">
        ...
        <div class="col-xl-6">
          ...
          <div class="card">
            <div class="card-body profile-card pt-2 d-flex flex-column align-items-center">
              ...
              <img src="image/ziqa.jpg" alt="Profile" class="rounded-circle">
              <h2>NUR HANIS HAZIQAH</h2>
              <h3>Web Designer</h3>
              <div class="social-links mt-2">           
                <a href="https://www.facebook.com/hanis.haziqah.9/" class="facebook"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/ziqanis_/" class="instagram"><i class="bi bi-instagram"></i></a>
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-body profile-overview pt-4 d-flex flex-column align-items-center"></div>
            <div class="card-body">
              <!-- Bordered Tabs -->
          ...
          <div class="card-body">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Email</div>
                  <div class="col-lg-9 col-md-8">haziqahhaizad@gmail.com</div>
                </div>
